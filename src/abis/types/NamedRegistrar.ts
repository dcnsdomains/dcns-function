...
export interface NamedRegistrarInterface extends utils.Interface {
  functions: {
...
export interface NamedRegistrar extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: NamedRegistrarInterface;
  ...
  functions: {
    ...
    baseNodeName(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    baseNodeName(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    baseNodeName(overrides?: CallOverrides): Promise<PopulatedTransaction>;
